...
Sadness - dark, 
Trust - lord. 
The most common are lord, Jon, Ned etc., which makes sense since the story involves those characters. 
I would expect it to be more negative, which is true, but there is a lot of positive words too. 
